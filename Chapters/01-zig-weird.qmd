...
which describe the project, you can easily include this library in
...
where exactly the array ends, or, in other words, to find how many elements the array of bytes contain.
