...
The phrase above is still important for C programmers too. Because, even if C is a simple
language, it's still hard sometimes to read and understand C code. For example, pre-processor macros in
C are a frequent source of confusion. They sometimes really make it hard to debug
...
GitHub issues opened  the official Zig repository. More specifically, the issues
