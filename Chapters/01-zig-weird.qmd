...
codebases, such as the [Javascript runtime Bun](https://github.com/oven-sh/bun)[^bunjs].
Both of these assets are available on GitHub,
...
the official GitHub repository of Zig. Access this folder, and start exploring the Zig modules. If you want to search for
occurrences of a specific Zig function in this folder, remember to include `lang:Zig` in the GitHub search bar. This will limit
