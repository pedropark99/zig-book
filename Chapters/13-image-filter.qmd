...
we haven't discussed yet how to call C code from Zig, and use C libraries in Zig, etc.
...
But Zig integrates with C in a more direct way. You can call C functions directly without the need
to use a FFI.
...
Whenever you use a C library in your Zig code, you have to link your Zig code against this
