...
### Explaining threads in more technical terms
...
Thus, every thread that we create is always associated with a particular process in our computer.
In other words, a thread is always a subset of an existing process.
...
access to the same standard file descriptors and to some regions of memory.
