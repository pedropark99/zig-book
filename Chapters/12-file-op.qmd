...
A position indicator is like a pointer, or, an index. This "index" identifies the current
...
described by this file descriptor object, you move the position indicator.

In other words, any IO operation ends up moving the position indicator. For example, suppose
that we have a file of 300 bytes total in size. If you
...
position of the position indicator. Since the indicator is at a 100 bytes forward from
