...
If is not clear yet, the `zig` compiler is also a C compiler. In other words,
you can use the `zig` compiler to compile C projects, through the `zig cc`
command.
