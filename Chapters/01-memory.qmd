...
In order to a type have a known fixed size, this type must have only fixed size data members in it.
If this type inclues, for example, a variable sized array in it, then, this type do not have a known
