...
Computers fundamentally rely on memory to function. Is by having memory that computers
can temporarily store the data and values generated during computations
the values/results of your calculations. Without memory, the core concepts of
"variables" and "objects" in programming languages would be impossible.
