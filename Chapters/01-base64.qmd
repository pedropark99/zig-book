...
some bits to fill the 6-bits requirement, the algorithm simply adds extra zeros in this group
to fill the space that it needs. That is why in @fig-base64-algo1, in the third group after the 6-bit transformation,
