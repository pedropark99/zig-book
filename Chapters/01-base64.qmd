...
If the algorithm notices that there is a group of 6 bits that have some bits in it, but, at the same time it's
not full—lacking some bits to fill the 6-bits requirement ($0 < nbits < 6$, being $nbits$ the number of bits),
