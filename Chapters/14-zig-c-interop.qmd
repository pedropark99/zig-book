...
Because the compiler inteprets the string `"foo.txt"` as a C string given the current context.
...
As consequence, the underlying memory associated with this `new_user` object is unintialized,
