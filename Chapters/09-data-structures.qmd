...
We can also see at @fig-capacity-length that, when *length* and *capacity* are equal, it means that the array has no space left.
...
It is a "get and remove value" type of method.
