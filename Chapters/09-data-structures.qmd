...
Each implementation have it's own cons and pros, which we will
...
- the order of insertion is preserved, i.e. the order of the values that you find while iterating through this hashtable
is actually the order in which these values were inserted in the hashtable.
