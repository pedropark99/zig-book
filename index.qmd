...
reports, and analyses for research institutions and some of the largest companies in the
Brazilian financial sector, including BMG Bank, Sodexo, and Pan Bank.

But Pedro is also a passionate software developer who loves to
learn about and teach programming.
Although Pedro uses many different languages in his work, he is specialized in the R programming language, and has given several
